...
function index() {
	...
	$last = $version[0] . '.' . $version[2] . '.' . $version[4];
		...
		echo '<div class="content-box" style="width:700px!important;margin:auto;">',"\n" //<!-- Start Content Box -->
        	. '<div class="content-box-header"><h3>Installation Module Web TV Twitch</h3></div>',"\n"
		...
		$test = mysql_query("SELECT id FROM " . $nuked['prefix'] . "_modules WHERE nom='Web_tv_twitch'");
		...
		echo '<tr>
		<td>
		Vous allez installer le module <strong>Web TV Twitch</strong> <br /><br />
...
function update() {
	...
	//Efface les tables
	$req = mysql_query("DROP TABLE IF EXISTS ". $nuked['prefix'] ."_web_tv_twitch");
	$req = mysql_query("DROP TABLE IF EXISTS ". $nuked['prefix'] ."_web_tv_programme_twitch");
	$req = mysql_query("DELETE FROM ". $nuked['prefix'] ."_modules WHERE nom = 'Web_tv_twitch'");
        $req = mysql_query("DELETE FROM ". $nuked['prefix'] ."_stats WHERE nom = 'Web_tv_twitch'");

	$sql = "CREATE TABLE IF NOT EXISTS `".$nuked['prefix']."_web_tv_twitch` (
	...
	$req = mysql_query($sql);
        ...
        $sql = "CREATE TABLE IF NOT EXISTS `".$nuked['prefix']."_web_tv_programme_twitch` (
  	`id` int(11) NOT NULL AUTO_INCREMENT,
	...
	$sql = mysql_query("INSERT INTO ". $nuked['prefix'] ."_modules (`id`, `nom`, `niveau`, `admin`) VALUES ('', 'Web_tv_twitch', '0', '9');");
        $sql = mysql_query("INSERT INTO ". $nuked['prefix'] ."_stats (`nom`, `type`, `count`) VALUES ('Web_tv_twitch', 'pages', '0');");

        top();
        echo '<div class="tab-content" id="tab2" style="width:700px!important;margin:auto;">'
        . "<br /><br /><div class=\"notification success png_bg\"><div>Le module Web TV Twitch a été installé correctement.<br />
...
function nan() {
	...
	top();
        echo '<div class="tab-content" id="tab2" style="width:700px!important;margin:auto;">'
	. "<br /><br /><div class=\"notification error png_bg\"><div>Installation Web TV Twitch annulé .</div></div>";
